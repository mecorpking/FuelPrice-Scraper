...
const referer_1 = require("./hooks/referer");
const handlers = [
...
const gotScraping = got_cjs_1.got.extend({
    ...
    context: {
        headerGenerator: new header_generator_1.HeaderGenerator(),
...
const obj = {
    get: gotScraping.get,
    post: gotScraping.post,
    put: gotScraping.put,
    patch: gotScraping.patch,
    head: gotScraping.head,
    delete: gotScraping.delete,
};
module.exports = obj;
// export default obj
